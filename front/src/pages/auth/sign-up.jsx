...
//                 Name
//               </Typography>
//               <Input size="lg" placeholder="First Name" className="border border-gray-300 focus:border-gray-900 w-full" />
//             </div>
//             <div className="flex flex-col w-full">
//               <Typography variant="small" color="blue-gray" className="mb-1 font-medium">
//                 Surname
//               </Typography>
//               <Input size="lg" placeholder="Last Name" className="border border-gray-300 focus:border-gray-900 w-full" />
//             </div>
//           </div>

//           {/* Phone Number */}
//           <div className="flex flex-col">
//             <label className="text-blue-gray-700 text-sm font-medium">Phone Number</label>
//             <Input size="lg" type="tel" placeholder="Enter your phone number" className="border border-gray-300 focus:border-gray-900" />
//           </div>

//           {/* Email */}
//           <div className="flex flex-col">
//             <label className="text-blue-gray-700 text-sm font-medium">Email</label>
//             <Input size="lg" type="email" placeholder="name@mail.com" className="border border-gray-300 focus:border-gray-900" />
//           </div>

//           {/* Password */}
//           <div className="flex flex-col">
//             <label className="text-blue-gray-700 text-sm font-medium">Password</label>
//             <Input size="lg" type="password" placeholder="Enter your password" className="border border-gray-300 focus:border-gray-900" />
//           </div>
...
export function SignUp() {
  ...
  const URL = import.meta.env.VITE_AUTH_API_URL; // Use http, not https
        ...
        <form onSubmit={handleSubmit} className="mt-8 mb-2 mx-auto w-full max-w-screen-lg lg:w-1/2 space-y-6">
          <div className="flex flex-col xl:flex-row gap-4 w-full">
            <div className="flex flex-col w-full">
              ...
              <Input name="name" size="lg" placeholder="First Name" value={formData.name} onChange={handleChange} />
            </div>
            <div className="flex flex-col w-full">
              <Typography variant="small" color="blue-gray" className="mb-1 font-medium">
                Surname
